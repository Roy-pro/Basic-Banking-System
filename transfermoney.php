...
<body class="center">
    <div class="header">
            ...
            <div class="header-right">
                ...
                <a class= "active" href="transfermoney.php">Users</a>
                    ...
                    <table class="table table-striped table-dark table-md table-hover table-bordered w-auto sort" align="center" style="margin-top: 40px; margin-bottom: 90px; text-align: center;" id="userTable">
                        ...
                        <tbody>
                            ...
                            <tr style="color:black;">
                                ...
                                <td><a href = "selecteduserdetails.php?id=<?php echo $rows['id'];?>"><button name = "Transfer Credits" value = "Transfer Credits" type="submit" class="btn btn-secondary" style="font-weight: 700;"><span class="fa fa-exchange fa-sm"></span> Transfer Credits</button></a></td>
                            </tr>
                            <?php
                                }
                            ?>
